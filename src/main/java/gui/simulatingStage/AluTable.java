...
public class AluTable {
  ...
  public static VBox createIntegerTable(ArrayList<? extends Stage> table,int size,String type){
      ...
      TableColumn<IntegerStage, String> QjCol = new TableColumn<>("Qi");
      QjCol.setCellValueFactory(new PropertyValueFactory<>("Qi"));


      integerAdderTableView.getColumns().addAll(stageCol,busyCol,opCol,VjCol,QjCol);
